...
public:
	...
	class UInstancedStaticMeshComponent*          Foundation;                                        // 0x08D8(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
