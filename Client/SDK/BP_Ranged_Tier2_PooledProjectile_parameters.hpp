...
public:
	...
	struct FCrAiProjectileParameters              K2Node_MakeStruct_CrAiProjectileParameters;        // 0x0080(0x0060)(NoDestructor)
	...
	float                                         CallFunc_RandomFloatInRangeFromStream_ReturnValue; // 0x0120(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_RandomFloatInRangeFromStream_ReturnValue_1; // 0x0164(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_RandomFloatInRangeFromStream_Min_ImplicitCast; // 0x0258(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_RandomFloatInRangeFromStream_Max_ImplicitCast; // 0x025C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        K2Node_VariableSet_LVector_Len_ImplicitCast;       // 0x0260(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_RandomFloatInRangeFromStream_Max_ImplicitCast_1; // 0x0268(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_RotateAngleAxis_AngleDeg_ImplicitCast;    // 0x026C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct BP_Ranged_Tier2_PooledProjectile_C_UserConstructionScript final
{
public:
...
DUMPER7_ASSERTS_BP_Ranged_Tier2_PooledProjectile_C_UserConstructionScript;
