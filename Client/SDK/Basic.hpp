...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0E1D9F40;
	constexpr int32 AppendString      = 0x014A8040;
	constexpr int32 GNames            = 0x0E09C900;
	constexpr int32 GWorld            = 0x0DEA86D0;
	constexpr int32 ProcessEvent      = 0x017731F0;
