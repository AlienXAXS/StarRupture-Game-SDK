...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0E1D2AC0;
	constexpr int32 AppendString      = 0x014A8090;
	constexpr int32 GNames            = 0x0E095480;
	constexpr int32 GWorld            = 0x0DEA16D0;
	constexpr int32 ProcessEvent      = 0x01773240;
