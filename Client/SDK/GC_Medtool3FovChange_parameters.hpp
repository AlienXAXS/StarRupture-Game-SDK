...
// Function GC_Medtool3FovChange.GC_Medtool3FovChange_C.OnActive
// 0x0118 (0x0118 - 0x0000)
struct GC_Medtool3FovChange_C_OnActive final
{
public:
	...
	TScriptInterface<class IAuCameraInterface>    CallFunc_AddAdditiveModifier_self_CastInput;       // 0x00F8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetDisplayName_ReturnValue;               // 0x0108(0x0010)(ZeroConstructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_GC_Medtool3FovChange_C_OnActive;

// Function GC_Medtool3FovChange.GC_Medtool3FovChange_C.OnRemove
// 0x0108 (0x0108 - 0x0000)
struct GC_Medtool3FovChange_C_OnRemove final
{
public:
	class AActor*                                 MyTarget;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                 Parameters;                                        // 0x0008(0x00D8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	...
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x00F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_F1[0x7];                                       // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IAuCameraInterface>    CallFunc_RemoveAdditiveModifier_self_CastInput;    // 0x00F8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_GC_Medtool3FovChange_C_OnRemove;
