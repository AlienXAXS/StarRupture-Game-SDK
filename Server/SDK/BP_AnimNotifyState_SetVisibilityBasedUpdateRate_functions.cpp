...
#include "BP_AnimNotifyState_SetVisibilityBasedUpdateRate_classes.hpp"
...
bool UBP_AnimNotifyState_SetVisibilityBasedUpdateRate_C::Received_NotifyEnd(class USkeletalMeshComponent* MeshComp_Received_NotifyEnd, class UAnimSequenceBase* Animation_Received_NotifyEnd, const struct FAnimNotifyEventReference& EventReference_Received_NotifyEnd) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AnimNotifyState_SetVisibilityBasedUpdateRate_C", "Received_NotifyEnd");

	Params::BP_AnimNotifyState_SetVisibilityBasedUpdateRate_C_Received_NotifyEnd Parms{};
...
// Function BP_AnimNotifyState_SetVisibilityBasedUpdateRate.BP_AnimNotifyState_SetVisibilityBasedUpdateRate_C.Received_NotifyBegin
// (Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent, Const)
// Parameters:
...
bool UBP_AnimNotifyState_SetVisibilityBasedUpdateRate_C::Received_NotifyBegin(class USkeletalMeshComponent* MeshComp_Received_NotifyBegin, class UAnimSequenceBase* Animation_Received_NotifyBegin, float TotalDuration_Received_NotifyBegin, const struct FAnimNotifyEventReference& EventReference_Received_NotifyBegin) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_AnimNotifyState_SetVisibilityBasedUpdateRate_C", "Received_NotifyBegin");

	Params::BP_AnimNotifyState_SetVisibilityBasedUpdateRate_C_Received_NotifyBegin Parms{};
