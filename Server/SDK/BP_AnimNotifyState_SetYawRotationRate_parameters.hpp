...
struct BP_AnimNotifyState_SetYawRotationRate_C_Received_NotifyEnd final
{
public:
...
DUMPER7_ASSERTS_BP_AnimNotifyState_SetYawRotationRate_C_Received_NotifyEnd;

// Function BP_AnimNotifyState_SetYawRotationRate.BP_AnimNotifyState_SetYawRotationRate_C.Received_NotifyBegin
// 0x0088 (0x0088 - 0x0000)
struct BP_AnimNotifyState_SetYawRotationRate_C_Received_NotifyBegin final
{
public:
	class USkeletalMeshComponent*                 MeshComp;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class UAnimSequenceBase*                      Animation;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	TScriptInterface<class IMassEnemyActor>       K2Node_DynamicCast_AsMass_Enemy_Actor;             // 0x0060(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_SetYawRotationRate_Lifetime_ImplicitCast; // 0x0080(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_BP_AnimNotifyState_SetYawRotationRate_C_Received_NotifyBegin;
