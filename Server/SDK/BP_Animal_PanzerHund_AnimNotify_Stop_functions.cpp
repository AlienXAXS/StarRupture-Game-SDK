...
#include "BP_Animal_PanzerHund_AnimNotify_Stop_classes.hpp"
#include "BP_Animal_PanzerHund_AnimNotify_Stop_parameters.hpp"
...
bool UBP_Animal_PanzerHund_AnimNotify_Stop_C::Received_Notify(class USkeletalMeshComponent* MeshComp_Received_Notify, class UAnimSequenceBase* Animation_Received_Notify, const struct FAnimNotifyEventReference& EventReference_Received_Notify) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_Animal_PanzerHund_AnimNotify_Stop_C", "Received_Notify");

	Params::BP_Animal_PanzerHund_AnimNotify_Stop_C_Received_Notify Parms{};
