...
void ABP_BaseCore_Tiles4x4_C::ReceiveTick(float DeltaSeconds_ReceiveTick)
{
...
void ABP_BaseCore_Tiles4x4_C::ReceiveActorBeginOverlap(class AActor* OtherActor_ReceiveActorBeginOverlap)
{
	static class UFunction* Func = nullptr;
