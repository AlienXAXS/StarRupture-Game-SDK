...
struct BP_Exploder_Tier3_PooledProjectilePiece_C_ExecuteUbergraph_BP_Exploder_Tier3_PooledProjectilePiece final
{
public:
	...
	struct FCrAiProjectileParameters              K2Node_Event_InProjectileParameters;               // 0x01F0(0x0060)(ConstParm, NoDestructor)
	struct FCrAiProjectileParameters              K2Node_MakeStruct_CrAiProjectileParameters;        // 0x0250(0x0060)(NoDestructor)
	class UCrAiProjectileSubsystem*               CallFunc_GetWorldSubsystem_ReturnValue;            // 0x02B0(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsServer_ReturnValue;                     // 0x02B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_DealDamageToActor_ReturnValue;            // 0x02C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
