...
public:
	...
	class UInstancedStaticMeshComponent*          Foundation;                                        // 0x0860(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
