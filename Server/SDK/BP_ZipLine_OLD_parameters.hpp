...
struct BP_ZipLine_OLD_C_ExecuteUbergraph_BP_ZipLine_OLD final
{
public:
	...
	class UWBP_ZipLine_OLDControls_Tooltip_C*     CallFunc_Create_ReturnValue;                       // 0x0078(0x0008)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
