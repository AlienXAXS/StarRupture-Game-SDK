...
#include "BTTask_Exploder_Tier2_Actor_DestroyInfectionEntity_classes.hpp"
#include "BTTask_Exploder_Tier2_Actor_DestroyInfectionEntity_parameters.hpp"
...
void UBTTask_Exploder_Tier2_Actor_DestroyInfectionEntity_C::ReceiveExecuteAI(class AAIController* OwnerController_ReceiveExecuteAI, class APawn* ControlledPawn_ReceiveExecuteAI)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BTTask_Exploder_Tier2_Actor_DestroyInfectionEntity_C", "ReceiveExecuteAI");

	Params::BTTask_Exploder_Tier2_Actor_DestroyInfectionEntity_C_ReceiveExecuteAI Parms{};
