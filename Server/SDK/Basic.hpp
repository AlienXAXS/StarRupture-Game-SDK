...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0D2243D0;
	constexpr int32 AppendString      = 0x0141D970;
	constexpr int32 GNames            = 0x0D0E6D80;
	constexpr int32 GWorld            = 0x0CF10EA0;
	constexpr int32 ProcessEvent      = 0x016E8320;
