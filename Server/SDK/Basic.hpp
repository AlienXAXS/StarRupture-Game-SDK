...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0D2307D0;
	constexpr int32 AppendString      = 0x0141D9D0;
	constexpr int32 GNames            = 0x0D0F3180;
	constexpr int32 GWorld            = 0x0CF1CEA0;
	constexpr int32 ProcessEvent      = 0x016E8380;
