...
// 0x0200 (0x0338 - 0x0138)
struct FCrMassBuildingClientBubbleSerializer final : public FMassClientBubbleSerializerBase
{
public:
	uint8                                         Pad_138[0x1F0];                                    // 0x0138(0x01F0)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FCrMassBuildingFastArrayItem>   Buildings;                                         // 0x0328(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
};
...
{
public:
	uint8                                         Pad_138[0x1C8];                                    // 0x0138(0x01C8)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FCrMassDroneBuildingFastArrayItem> Buildings;                                      // 0x0300(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
};
...
{
public:
	uint8                                         Pad_138[0x158];                                    // 0x0138(0x0158)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FCrMassSimpleBuildingFastArrayItem> Buildings;                                     // 0x0290(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
};
